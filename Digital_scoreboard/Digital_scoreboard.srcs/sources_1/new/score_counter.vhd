...
entity score_counter is
    Port ( 
        ...
        pointup_team1    : in  STD_LOGIC;  -- p?idání bodu týmu 1
        pointup_team2    : in  STD_LOGIC;  -- p?idání bodu týmu 2
...
begin
    ...
    begin
        if rising_edge(clk) then
            if rst = '1' then
                -- reset skóre obou tým?
                team1_unit <= 0;
                team1_tens <= 0;
                team2_unit <= 0;
                team2_tens <= 0;
            else
                -- náb?žná hrana stisku tla?ítka pro tým 1
                ...
                -- náb?žná hrana stisku tla?ítka pro tým 2
            ...
            -- uložení p?edchozích stav? tla?ítek
            last_pointup_team1 <= pointup_team1;
            last_pointup_team2 <= pointup_team2;
        end if;
    end process;

    -- p?evod výstup? na std_logic_vector
