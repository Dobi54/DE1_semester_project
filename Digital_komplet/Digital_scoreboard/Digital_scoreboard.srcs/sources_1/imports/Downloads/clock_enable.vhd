...
entity clock_enable is
    generic (
        N_PERIODS_50Hz : integer := 2_000_000;   -- Number of clock cycles for 50Hz
    ...
    port (
        ...
        clk50Hz  : out std_logic   -- Output pulse at 50 Hz
    );
        ...
        if (rising_edge(clk)) then
            if rst = '1' then
                ...
                if sig_count_50Hz = N_PERIODS_50Hz - 1 then
                    sig_count_50Hz <= (others => '0'); -- Reset counter
                    clk50Hz        <= '1';             -- Generate a pulse
                else
